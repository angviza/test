...
import static org.quinn.test.ImgUtils.convertMat;
...
public class Test4 {
    ...
    public static void main(String[] args) {
        // Load the image
        String imgPath=FileUtils.getResPath("res/iris3.jpg");
        ...
        // Show source image
//        org.opencv.core.Mat src1 = Imgcodecs.imread(imgPath);
//        org.opencv.core.Mat dst1 = src1.clone();
//
//        org.opencv.photo.Photo.illuminationChange(src1,src1,dst1);
//
//        Imgproc.GaussianBlur(src1, dst1, new org.opencv.core.Size(3, 3), 0);
//        Imgproc.Canny(src1, dst1, 40, 100);
//        imshow("Source Image", convertMat(dst1));
        //归一化图像 https://blog.csdn.net/lanmeng_smile/article/details/49903865
        //        Mat normalize=new Mat();
        //        normalize(src,src,1,0,NORM_MINMAX,-1,new Mat());
        //        imshow("normalize Source Image", src);
        //        if(true)
        //            return;
        //end 图像归一化
        ...
        //反色处理
        //bitwise_not(src, src);
        normalize(src, src, 1, 0.3, NORM_MINMAX, -1, new Mat());
        imshow("normalize Source Image", src);
        //end 反色处理
        ...
        for (int i = 0; i < circles.total(); i++) {
            ...
            cvCircle(new IplImage(src), center, radius, CvScalar.RED, 1, CV_AA, 0);
