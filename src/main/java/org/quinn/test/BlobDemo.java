...
public class BlobDemo {
    ...
    public static void demo() {
        ...
        for (int k = 0; k < 7; k++) {
            if (k == 0) {
                RawImage = cvLoadImage(FileUtils.getResPath("BlackBalls.jpg"));
                MinArea = 250;
                ErodeCount = 0;
                DilateCount = 1;
            } else if (k == 1) {
                RawImage = cvLoadImage(FileUtils.getResPath("Shapes1.jpg"));
                MinArea = 6;
                ErodeCount = 0;
                DilateCount = 1;
            } else if (k == 2) {
                RawImage = cvLoadImage(FileUtils.getResPath("Shapes2.jpg"));
                MinArea = 250;
                ErodeCount = 0;
                DilateCount = 1;
            }
            else if(k == 3) {
                RawImage = cvLoadImage("d:\\lakeResult.jpg");
                MinArea = 2800;
                ErodeCount = 0;
                DilateCount = 1;
            }
            else if (k == 4) {
                RawImage = cvLoadImage(FileUtils.getResPath("Blob2.jpg"));
                MinArea = 2800;
                ErodeCount = 1;
                DilateCount = 1;
            } else if (k == 5) {
                RawImage = cvLoadImage(FileUtils.getResPath("Blob3.jpg"));
                MinArea = 2800;
                ErodeCount = 1;
                DilateCount = 1;
            } else if (k == 6) {
                RawImage = cvLoadImage(FileUtils.getResPath("Rice.jpg"));
                MinArea = 30;
                ErodeCount = 2;
                DilateCount = 1;
            }
