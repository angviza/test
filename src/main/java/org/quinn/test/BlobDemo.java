...
public class BlobDemo
{
    ...
    public static void demo()
    {
        ...
        for(int k = 0; k < 7; k++)
        {
            if(k == 0) { RawImage = cvLoadImage("E:\\WORKSPACES\\TEST\\iris\\src\\main\\resources\\BlackBalls.jpg"); MinArea = 250; ErodeCount = 0; DilateCount = 1; }
            else if(k == 1) { RawImage = cvLoadImage("E:\\WORKSPACES\\TEST\\iris\\src\\main\\resources\\Shapes1.jpg"); MinArea = 6; ErodeCount = 0; DilateCount = 1; }
            else if(k == 2) { RawImage = cvLoadImage("E:\\WORKSPACES\\TEST\\iris\\src\\main\\resources\\Shapes2.jpg"); MinArea = 250; ErodeCount = 0; DilateCount = 1; }
//            else if(k == 3) {
...
//                DilateCount = 1;
//            }
            else if(k == 4) { RawImage = cvLoadImage("E:\\WORKSPACES\\TEST\\iris\\src\\main\\resources\\Blob2.jpg"); MinArea = 2800; ErodeCount = 1; DilateCount = 1; }
            else if(k == 5) { RawImage = cvLoadImage("E:\\WORKSPACES\\TEST\\iris\\src\\main\\resources\\Blob3.jpg"); MinArea = 2800; ErodeCount = 1; DilateCount = 1; }
            else if(k == 6) { RawImage = cvLoadImage("E:\\WORKSPACES\\TEST\\iris\\src\\main\\resources\\Rice.jpg"); MinArea = 30; ErodeCount = 2; DilateCount = 1; }
